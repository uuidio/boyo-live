...
//            shownTabName = position;
    ...
    private void initSpeciallyView() {
        ...
        //}
        //只获取特效素材,屏蔽水印素材
        StickerCategaryBean stickerCategaryBean = new StickerCategaryBean(idArray[0], nameArray[0]);
        titles.add(stickerCategaryBean);
...
//                }
    ...
    @Override
    public void setEffectListener(DefaultBeautyEffectListener effectListener) {
...
//    toggleBeautyView
    ...
    public void onFilterChanged(FilterBean filterBean) {
        if (mEffectListener != null) {
            mEffectListener.onFilterChanged(filterBean);
        }
    }
