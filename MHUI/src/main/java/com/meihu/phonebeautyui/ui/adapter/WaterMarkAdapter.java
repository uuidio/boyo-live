...
public class WaterMarkAdapter extends BaseBeautyAdapter<WaterMarkAdapter.ViewHolder, WatermarkBean> {
    ...
    WaterMarkAdapter(Context context) {
        super(context, 1);
//        TypedArray speciallyArray = context.getResources().obtainTypedArray(R.array.specially_watermark_icon_list);
//        TypedArray speciallyArraySel = context.getResources().obtainTypedArray(R.array.specially_watermark_sel_list);
...
//            WatermarkBean beautyBean = new WatermarkBean(imgSrc, ImgSrcSel, beautyName, BeautyTypeEnum.WATER_TYPE_ENUM,false, WaterAlignEnum.getValue(i));
...
//                BeautyDataModel.getInstance().setWatermarkName(speciallyBean.getEffectName());
