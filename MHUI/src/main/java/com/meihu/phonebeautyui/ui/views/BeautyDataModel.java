...
public class BeautyDataModel implements IBeautyData {
    ...
    @Deprecated
    private FilterEnum filterEnum;  //滤镜    //old  filterEnum
    private FilterBean filterBean;  //滤镜    view
    private String filterName; //滤镜名称   manager
    ...
    private boolean isQuickBeautyMode;
    private int quickProgress = 50;
