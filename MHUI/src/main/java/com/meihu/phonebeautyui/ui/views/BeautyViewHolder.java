...
public class BeautyViewHolder extends BaseBeautyViewHolder implements View.OnClickListener {
    ...
    BeautyViewHolder(Context context, ViewGroup parentView) {
        super(context, parentView);
    }

    BeautyViewHolder(Context context, ViewGroup parentView, Object... args) {
    ...
    public void setStickerCategaryData(List<StickerCategaryBean> titles) {
        ...
        stickerPagerAdapter = new StickerPagerAdapter(titles);
...
//        BeautyDataModel.getInstance().setOnekeyBeauty(oneKeyBeautyName);
    }
...
//        BeautyDataModel.getInstance().setBeautyProgress(mContext.getResources().getString(QuickBeautyShapeEnum.SHAPE_BIGEYE.getStringId()), shapeData[0]);
//        BeautyDataModel.getInstance().setBeautyProgress(mContext.getResources().getString(QuickBeautyShapeEnum.SHAPE_EYEBROW.getStringId()), shapeData[1]);
//        BeautyDataModel.getInstance().setBeautyProgress(mContext.getResources().getString(QuickBeautyShapeEnum.SHAPE_EYELENGTH.getStringId()), shapeData[2]);
//        BeautyDataModel.getInstance().setBeautyProgress(mContext.getResources().getString(QuickBeautyShapeEnum.SHAPE_EYECORNER.getStringId()), shapeData[3]);
//        BeautyDataModel.getInstance().setBeautyProgress(mContext.getResources().getString(QuickBeautyShapeEnum.SHAPE_FACE.getStringId()), shapeData[4]);
//        BeautyDataModel.getInstance().setBeautyProgress(mContext.getResources().getString(QuickBeautyShapeEnum.SHAPE_MOUSE.getStringId()), shapeData[5]);
//        BeautyDataModel.getInstance().setBeautyProgress(mContext.getResources().getString(QuickBeautyShapeEnum.SHAPE_NOSE.getStringId()), shapeData[6]);
//        BeautyDataModel.getInstance().setBeautyProgress(mContext.getResources().getString(QuickBeautyShapeEnum.SHAPE_CHIN.getStringId()), shapeData[7]);
//        BeautyDataModel.getInstance().setBeautyProgress(mContext.getResources().getString(QuickBeautyShapeEnum.SHAPE_FOREHEAD.getStringId()), shapeData[8]);
//        BeautyDataModel.getInstance().setBeautyProgress(mContext.getResources().getString(QuickBeautyShapeEnum.SHAPE_LENGTHNOSE.getStringId()), shapeData[9]);
//        BeautyDataModel.getInstance().setBeautyProgress(mContext.getResources().getString(QuickBeautyShapeEnum.SHAPE_SHAVE_FACE.getStringId()), shapeData[10]);
//        BeautyDataModel.getInstance().setBeautyProgress(mContext.getResources().getString(QuickBeautyShapeEnum.SHAPE_EYEALAT.getStringId()), shapeData[11]);
//        mhBeautyManager.setAllShapes(shapeData);
