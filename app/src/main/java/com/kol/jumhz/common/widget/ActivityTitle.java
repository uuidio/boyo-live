...
public class ActivityTitle extends RelativeLayout {
    ...
    private void setUpView(){
        tvReturn = findViewById(R.id.menu_return);
        tvReturn.setTextColor(getResources().getColor(R.color.color_title_black));
        tvTitle = findViewById(R.id.title);
        tvMore = findViewById(R.id.menu_more);
