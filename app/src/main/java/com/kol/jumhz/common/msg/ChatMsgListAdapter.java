...
//        }
        ...
        holder.sendContext.setOnLongClickListener(v -> {
            if (onItemLongClickListener != null) {
                onItemLongClickListener.onItemLongClick(v, item, position);
                return true;
            }
            return false;
        });
    ...
    public interface  OnItemLongClickListener{
        void onItemLongClick(View view, ChatEntity entity, int position);
    }
