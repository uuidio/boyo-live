 ...
 */
public class RelevanceLiveGoodsShowView extends RecyclerView.Adapter<RelevanceLiveGoodsShowView.ViewHolder> implements Filterable {
    public ArrayList<LiveGoodsBean> list;
    private Context mContext;
    private MyFilter filter = null;// 创建MyFilter对象
    private FilterListener listener;// 接口对象

    public RelevanceLiveGoodsShowView(Context mContent, ArrayList<LiveGoodsBean> list, FilterListener filterListener){
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        //设置checkBox改变监听
        holder.itemCb.setOnCheckedChangeListener((buttonView, isChecked) -> list.get(position).setChecked(isChecked));
        ...
        //holder.item_iv_move.setOnTouchListener(new View.OnTouchListener() {
        //    @Override
    ...
    static class ViewHolder extends  RecyclerView.ViewHolder{
        ...
        //private ImageView item_iv_move;
        ...
        private ViewHolder(View itemView) {
            ...
            //item_iv_move=itemView.findViewById(R.id.iv_move);
        }
    }
