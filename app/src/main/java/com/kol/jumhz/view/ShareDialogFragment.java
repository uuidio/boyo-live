...
/**
 * @ClassName: ShareDialogFragment
 * @Author: LanLnk
 * @CreateDate: 2020-05-06 15:00
 * @Description: 直播预告分享
 */
public class ShareDialogFragment extends android.app.DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mDetailDialog.setContentView(R.layout.fragment_dialog_share);
        ...
        TextView tvTime = mDetailDialog.findViewById(R.id.tv_share_time);
    ...
    public void saveBitmapFromView(View view) {
        ...
        DateFormat format = new SimpleDateFormat("yyyyMMddHHmmss",java.util.Locale.getDefault());
        saveBitmap(bmp,format.format(new Date())+".JPEG");
    }

    /**
     * @ClassName: saveBitmap
     * @Description: 保存文件，文件名为当前日期
     */
